...
# Give the I/P to the data_transformation component
@dataclass
...
class DataTransformation:
    ...
    # to create pkl files for data transformation purposes
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info(f"Applying preprocessing object on train & test dataset.")
